    ...
    <div class="container">
        <div class="backgroundcolor" style="border-radius: 10px;background-color: #F3F1FF; height: 97vh;box-shadow: 3px 4px 8px rgba(0, 0, 0, 0.25);margin-top: 15px;">
            ...
            <div class="kontendata col-11" style="margin-top: 25px;margin-left: 36px;">
                <form action="/editsup/{{$i->SUPPLIER_ID}}" method="POST">
                    @csrf
                    ...
                    <div class="inputbox col-8">
                        <input type="text" name="namasupplier" id="" value="{{$i -> SUPPLIER_NAMA }}">
                    </div>
                    <div class="judul col-5">
                        <label for="">
                            Kategori Supplier
                    ...
                    <div class="inputbox col-8">
                        <select name="kategorisupplier" id="">
                            <option value="{{$i -> SUPPLIER_KATEGORI_ID}}" selected disabled hidden>{{$i -> SUPPLIER_KATEGORI}}</option>
                    ...
                    <div class="inputbox col-8">
                        <input type="number" name="notlp" id="" value="{{$i -> SUPPLIER_NOTLP }}">
                    </div>
                    ...
                    <div class="inputbox col-8">
                        <input type="text" name="alamat" id="" value="{{$i -> SUPPLIER_ALAMAT }}" >
                    </div>
                    <div class="col-12" style="display: flex; margin-top: 30px;justify-content: flex-end;">
                    </form>
                        <form action="/editsup/{{$i-> SUPPLIER_ID}}/hps" method="POST">
                            @csrf
